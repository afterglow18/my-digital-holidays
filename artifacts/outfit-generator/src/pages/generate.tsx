...
const LM = {
  ...
  rows: [
    ...
    { sectionTop: 0.485, shelfY: 0.635, btnCY: 0.558, labelFrac: 0.92 },  // TOILETRIES  (shelf 3)
    { sectionTop: 0.650, shelfY: 0.795, btnCY: 0.720, labelFrac: 0.92 },  // ESSENTIALS  (shelf 4)
  ],
