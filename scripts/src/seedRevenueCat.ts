...
const PROJECT_NAME        = "My Digital Holidays";
const APP_STORE_APP_NAME  = "My Digital Holidays";
const APP_STORE_BUNDLE_ID = "com.mydigitalholidays.app";
...
const PRODUCTS: ProductDef[] = [
  {
    ...
    displayName: "Monthly – My Digital Holidays",
    type:        "subscription",
    duration:    "P1M",
  ...
  },
  {
    ...
    displayName: "Yearly – My Digital Holidays",
    type:        "subscription",
    duration:    "P1Y",
  ...
  },
  {
    ...
    displayName: "Lifetime – My Digital Holidays",
    type:        "non_consumable",
