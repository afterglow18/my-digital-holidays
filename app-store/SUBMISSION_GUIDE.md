# App Store Submission Guide — My Digital Holidays
...
3. Fill in:
   - Platform: iOS
   - Name: **My Digital Holidays**
   - Primary Language: English (U.S.)
   - Bundle ID: **com.mydigitalholidays.app** *(you'll need to register this in your Developer account first)*
...
3. Bundle ID: `com.mydigitalholidays.app`
...
- [ ] In-App Purchase created in App Store Connect (Product ID: `com.mydigitalholidays.app.premium`)
...
→ Register `com.mydigitalholidays.app` in your Apple Developer account (Step 3)
